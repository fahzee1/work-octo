...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CEOFeedback.read'
        db.add_column('contact_ceofeedback', 'read', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CEOFeedback.read'
        db.delete_column('contact_ceofeedback', 'read')
