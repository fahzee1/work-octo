...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CEOFeedback.date_read'
        db.add_column('contact_ceofeedback', 'date_read', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CEOFeedback.date_read'
        db.delete_column('contact_ceofeedback', 'date_read')
