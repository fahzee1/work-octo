...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PayItForward'
        db.create_table('contact_payitforward', (
        ...
        db.send_create_signal('contact', ['PayItForward'])


    def backwards(self, orm):
        
        # Deleting model 'PayItForward'
        db.delete_table('contact_payitforward')
