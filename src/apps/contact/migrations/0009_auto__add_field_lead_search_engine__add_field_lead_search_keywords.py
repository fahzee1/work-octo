...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lead.search_engine'
        db.add_column('contact_lead', 'search_engine', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Lead.search_keywords'
        db.add_column('contact_lead', 'search_keywords', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lead.search_engine'
        db.delete_column('contact_lead', 'search_engine')

        # Deleting field 'Lead.search_keywords'
        db.delete_column('contact_lead', 'search_keywords')
