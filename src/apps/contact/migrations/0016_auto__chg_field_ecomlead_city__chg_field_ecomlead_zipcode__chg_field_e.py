...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EcomLead.city'
        db.alter_column('contact_ecomlead', 'city', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'EcomLead.zipcode'
        db.alter_column('contact_ecomlead', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'EcomLead.state'
        db.alter_column('contact_ecomlead', 'state', self.gf('django.contrib.localflavor.us.models.USStateField')(max_length=2, null=True))

        # Changing field 'EcomLead.address'
        db.alter_column('contact_ecomlead', 'address', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))


    def backwards(self, orm):
        
        # Changing field 'EcomLead.city'
        db.alter_column('contact_ecomlead', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=32))

        # Changing field 'EcomLead.zipcode'
        db.alter_column('contact_ecomlead', 'zipcode', self.gf('django.db.models.fields.CharField')(default='', max_length=12))

        # Changing field 'EcomLead.state'
        db.alter_column('contact_ecomlead', 'state', self.gf('django.contrib.localflavor.us.models.USStateField')(default='', max_length=2))

        # Changing field 'EcomLead.address'
        db.alter_column('contact_ecomlead', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=128))
