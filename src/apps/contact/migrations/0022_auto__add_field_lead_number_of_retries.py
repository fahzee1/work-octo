...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lead.number_of_retries'
        db.add_column('contact_lead', 'number_of_retries', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lead.number_of_retries'
        db.delete_column('contact_lead', 'number_of_retries')
