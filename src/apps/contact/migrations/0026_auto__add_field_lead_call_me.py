...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lead.call_me'
        db.add_column('contact_lead', 'call_me', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lead.call_me'
        db.delete_column('contact_lead', 'call_me')
    ...
    models = {
        ...
        'contact.lead': {
            ...
            'call_me': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
