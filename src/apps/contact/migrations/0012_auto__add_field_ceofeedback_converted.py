...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CEOFeedback.converted'
        db.add_column('contact_ceofeedback', 'converted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CEOFeedback.converted'
        db.delete_column('contact_ceofeedback', 'converted')
