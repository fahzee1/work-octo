...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lead.lc_url'
        db.add_column('contact_lead', 'lc_url', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'Lead.lc_id'
        db.add_column('contact_lead', 'lc_id', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'Lead.lc_error'
        db.add_column('contact_lead', 'lc_error', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lead.lc_url'
        db.delete_column('contact_lead', 'lc_url')

        # Deleting field 'Lead.lc_id'
        db.delete_column('contact_lead', 'lc_id')

        # Deleting field 'Lead.lc_error'
        db.delete_column('contact_lead', 'lc_error')
