...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lead.device'
        db.add_column('contact_lead', 'device', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'Lead.operating_system'
        db.add_column('contact_lead', 'operating_system', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'Lead.browser'
        db.add_column('contact_lead', 'browser', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lead.device'
        db.delete_column('contact_lead', 'device')

        # Deleting field 'Lead.operating_system'
        db.delete_column('contact_lead', 'operating_system')

        # Deleting field 'Lead.browser'
        db.delete_column('contact_lead', 'browser')
