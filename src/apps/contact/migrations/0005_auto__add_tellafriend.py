...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TellAFriend'
        db.create_table('contact_tellafriend', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=128)),
            ('friend_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('friend_email', self.gf('django.db.models.fields.EmailField')(max_length=128)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('contact', ['TellAFriend'])


    def backwards(self, orm):
        
        # Deleting model 'TellAFriend'
        db.delete_table('contact_tellafriend')
