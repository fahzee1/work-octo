...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lead.form_values'
        db.add_column('contact_lead', 'form_values', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True), keep_default=False)

        # Changing field 'Lead.email'
        db.alter_column('contact_lead', 'email', self.gf('django.db.models.fields.EmailField')(max_length=128, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Lead.form_values'
        db.delete_column('contact_lead', 'form_values')

        # Changing field 'Lead.email'
        db.alter_column('contact_lead', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=128))
