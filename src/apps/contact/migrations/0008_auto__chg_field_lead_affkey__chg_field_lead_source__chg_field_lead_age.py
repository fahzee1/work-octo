...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lead.affkey'
        db.alter_column('contact_lead', 'affkey', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Lead.source'
        db.alter_column('contact_lead', 'source', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Lead.agent_id'
        db.alter_column('contact_lead', 'agent_id', self.gf('django.db.models.fields.CharField')(max_length=24, null=True))

        # Changing field 'GoogleExperiment.name'
        db.alter_column('contact_googleexperiment', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))


    def backwards(self, orm):
        
        # Changing field 'Lead.affkey'
        db.alter_column('contact_lead', 'affkey', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'Lead.source'
        db.alter_column('contact_lead', 'source', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'Lead.agent_id'
        db.alter_column('contact_lead', 'agent_id', self.gf('django.db.models.fields.CharField')(default='', max_length=24))

        # Changing field 'GoogleExperiment.name'
        db.alter_column('contact_googleexperiment', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=64))
