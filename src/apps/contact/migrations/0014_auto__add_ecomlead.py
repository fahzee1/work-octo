...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EcomLead'
        db.create_table('contact_ecomlead', (
            ('lead_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['contact.Lead'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('contact', ['EcomLead'])


    def backwards(self, orm):
        
        # Deleting model 'EcomLead'
        db.delete_table('contact_ecomlead')
