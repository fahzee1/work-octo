...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TheFeed.visible_to_all'
        db.add_column('newsfeed_thefeed', 'visible_to_all', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TheFeed.visible_to_all'
        db.delete_column('newsfeed_thefeed', 'visible_to_all')
    ...
    models = {
        ...
        'newsfeed.thefeed': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 3, 10, 31, 31, 587484)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'visible_to_all': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        }
    }
