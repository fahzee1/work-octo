...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Textimonial.display'
        db.add_column('testimonials_textimonial', 'display', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Textimonial.display'
        db.delete_column('testimonials_textimonial', 'display')
