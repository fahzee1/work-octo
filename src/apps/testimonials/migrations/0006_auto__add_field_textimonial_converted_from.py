...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Textimonial.converted_from'
        db.add_column('testimonials_textimonial', 'converted_from', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contact.CEOFeedback'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Textimonial.converted_from'
        db.delete_column('testimonials_textimonial', 'converted_from_id')
