...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Affiliate.thank_you'
        db.add_column('affiliates_affiliate', 'thank_you', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Affiliate.thank_you'
        db.delete_column('affiliates_affiliate', 'thank_you')
