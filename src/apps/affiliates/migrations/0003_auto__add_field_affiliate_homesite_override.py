...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Affiliate.homesite_override'
        db.add_column('affiliates_affiliate', 'homesite_override', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Affiliate.homesite_override'
        db.delete_column('affiliates_affiliate', 'homesite_override')
