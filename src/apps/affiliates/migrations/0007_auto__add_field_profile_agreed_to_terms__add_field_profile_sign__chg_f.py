...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.agreed_to_terms'
        db.add_column('affiliates_profile', 'agreed_to_terms', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Profile.sign'
        db.add_column('affiliates_profile', 'sign', self.gf('django.db.models.fields.CharField')(default=None, max_length=200), keep_default=False)

        # Changing field 'Profile.fax'
        db.alter_column('affiliates_profile', 'fax', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Profile.agreed_to_terms'
        db.delete_column('affiliates_profile', 'agreed_to_terms')

        # Deleting field 'Profile.sign'
        db.delete_column('affiliates_profile', 'sign')

        # Changing field 'Profile.fax'
        db.alter_column('affiliates_profile', 'fax', self.gf('django.db.models.fields.CharField')(default='', max_length=128))
