...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Affiliate', fields ['name']
        db.delete_unique('affiliates_affiliate', ['name'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Affiliate', fields ['name']
        db.create_unique('affiliates_affiliate', ['name'])
