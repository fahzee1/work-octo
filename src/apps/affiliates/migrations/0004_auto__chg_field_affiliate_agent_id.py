...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Affiliate.agent_id'
        db.alter_column('affiliates_affiliate', 'agent_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16))


    def backwards(self, orm):
        
        # Changing field 'Affiliate.agent_id'
        db.alter_column('affiliates_affiliate', 'agent_id', self.gf('django.db.models.fields.CharField')(max_length=12, unique=True))
