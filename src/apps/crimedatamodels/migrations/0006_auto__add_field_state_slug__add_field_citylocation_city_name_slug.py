...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'State.slug'
        db.add_column('states', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=64, db_index=True), keep_default=False)

        # Adding field 'CityLocation.city_name_slug'
        db.add_column('citylocations', 'city_name_slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=64, db_index=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'State.slug'
        db.delete_column('states', 'slug')

        # Deleting field 'CityLocation.city_name_slug'
        db.delete_column('citylocations', 'city_name_slug')
