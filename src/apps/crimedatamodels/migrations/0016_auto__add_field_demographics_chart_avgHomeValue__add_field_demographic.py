...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Demographics.chart_avgHomeValue'
        db.add_column('crimedatamodels_demographics', 'chart_avgHomeValue', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Demographics.chart_homeSize'
        db.add_column('crimedatamodels_demographics', 'chart_homeSize', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Demographics.chart_ownVsRent'
        db.add_column('crimedatamodels_demographics', 'chart_ownVsRent', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Demographics.chart_avgHomeValue'
        db.delete_column('crimedatamodels_demographics', 'chart_avgHomeValue')

        # Deleting field 'Demographics.chart_homeSize'
        db.delete_column('crimedatamodels_demographics', 'chart_homeSize')

        # Deleting field 'Demographics.chart_ownVsRent'
        db.delete_column('crimedatamodels_demographics', 'chart_ownVsRent')
