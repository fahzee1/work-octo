...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LocalAddress.googleplus_url'
        db.add_column('crimedatamodels_localaddress', 'googleplus_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LocalAddress.googleplus_url'
        db.delete_column('crimedatamodels_localaddress', 'googleplus_url')
