...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('crimedatamodels_resources', (
        ...
        db.send_create_signal('crimedatamodels', ['Resources'])

        # Adding field 'State.license'
        db.add_column('states', 'license', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'CityCompetitor.door_window'
        db.add_column('crimedatamodels_citycompetitor', 'door_window', self.gf('django.db.models.fields.CharField')(default='3', max_length=255), keep_default=False)

        # Adding field 'CityCompetitor.alarm_monitoring'
        db.add_column('crimedatamodels_citycompetitor', 'alarm_monitoring', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CityCompetitor.free_equipment'
        db.add_column('crimedatamodels_citycompetitor', 'free_equipment', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CityCompetitor.no_fees'
        db.add_column('crimedatamodels_citycompetitor', 'no_fees', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CityCompetitor.warranty'
        db.add_column('crimedatamodels_citycompetitor', 'warranty', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CityCompetitor.monthly_cost'
        db.add_column('crimedatamodels_citycompetitor', 'monthly_cost', self.gf('django.db.models.fields.CharField')(default='19.99', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Resources'
        db.delete_table('crimedatamodels_resources')

        # Deleting field 'State.license'
        db.delete_column('states', 'license')

        # Deleting field 'CityCompetitor.door_window'
        db.delete_column('crimedatamodels_citycompetitor', 'door_window')

        # Deleting field 'CityCompetitor.alarm_monitoring'
        db.delete_column('crimedatamodels_citycompetitor', 'alarm_monitoring')

        # Deleting field 'CityCompetitor.free_equipment'
        db.delete_column('crimedatamodels_citycompetitor', 'free_equipment')

        # Deleting field 'CityCompetitor.no_fees'
        db.delete_column('crimedatamodels_citycompetitor', 'no_fees')

        # Deleting field 'CityCompetitor.warranty'
        db.delete_column('crimedatamodels_citycompetitor', 'warranty')

        # Deleting field 'CityCompetitor.monthly_cost'
        db.delete_column('crimedatamodels_citycompetitor', 'monthly_cost')
