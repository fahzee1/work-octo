...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        State = orm['crimedatamodels.State']
        for state in State.objects.all():
            state.slug = slugify(state.name)
            state.save()

        CityLocation = orm['crimedatamodels.CityLocation']
        for city in CityLocation.objects.all():
            city.city_name_slug = slugify(city.city_name)
            city.save()
