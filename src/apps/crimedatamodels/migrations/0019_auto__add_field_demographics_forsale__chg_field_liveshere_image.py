...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Demographics.forsale'
        db.add_column('crimedatamodels_demographics', 'forsale', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Changing field 'LivesHere.image'
        db.alter_column('crimedatamodels_liveshere', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Demographics.forsale'
        db.delete_column('crimedatamodels_demographics', 'forsale')

        # Changing field 'LivesHere.image'
        db.alter_column('crimedatamodels_liveshere', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        'crimedatamodels.demographics': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['crimedatamodels.CityLocation']"}),
            'forsale': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
