...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LivesHere.image'
        db.add_column('crimedatamodels_liveshere', 'image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100), keep_default=False)

        # Adding field 'LivesHere.image_height'
        db.add_column('crimedatamodels_liveshere', 'image_height', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'LivesHere.image_width'
        db.add_column('crimedatamodels_liveshere', 'image_width', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LivesHere.image'
        db.delete_column('crimedatamodels_liveshere', 'image')

        # Deleting field 'LivesHere.image_height'
        db.delete_column('crimedatamodels_liveshere', 'image_height')

        # Deleting field 'LivesHere.image_width'
        db.delete_column('crimedatamodels_liveshere', 'image_width')
    ...
    models = {
        ...
        'crimedatamodels.demographics': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['crimedatamodels.CityLocation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'liveshere': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'demographics'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['crimedatamodels.LivesHere']"}),
