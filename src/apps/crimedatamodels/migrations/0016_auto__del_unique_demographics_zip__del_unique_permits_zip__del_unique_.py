...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'LocalEducation', fields ['zip']
        db.delete_unique('crimedatamodels_localeducation', ['zip'])

        # Removing unique constraint on 'Universities', fields ['zip']
        db.delete_unique('crimedatamodels_universities', ['zip'])

        # Removing unique constraint on 'FarmersMarket', fields ['zip']
        db.delete_unique('crimedatamodels_farmersmarket', ['zip'])

        # Removing unique constraint on 'Permits', fields ['zip']
        db.delete_unique('crimedatamodels_permits', ['zip'])

        # Removing unique constraint on 'Demographics', fields ['zip']
        db.delete_unique('crimedatamodels_demographics', ['zip'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Demographics', fields ['zip']
        db.create_unique('crimedatamodels_demographics', ['zip'])

        # Adding unique constraint on 'Permits', fields ['zip']
        db.create_unique('crimedatamodels_permits', ['zip'])

        # Adding unique constraint on 'FarmersMarket', fields ['zip']
        db.create_unique('crimedatamodels_farmersmarket', ['zip'])

        # Adding unique constraint on 'Universities', fields ['zip']
        db.create_unique('crimedatamodels_universities', ['zip'])

        # Adding unique constraint on 'LocalEducation', fields ['zip']
        db.create_unique('crimedatamodels_localeducation', ['zip'])
