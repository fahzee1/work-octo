...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CrimeContent'
        db.create_table('crimedatamodels_crimecontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('population_type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('grade', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('crimedatamodels', ['CrimeContent'])


    def backwards(self, orm):
        
        # Deleting model 'CrimeContent'
        db.delete_table('crimedatamodels_crimecontent')
