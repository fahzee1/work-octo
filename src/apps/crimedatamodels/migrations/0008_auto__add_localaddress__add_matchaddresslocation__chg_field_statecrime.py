...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StateCrimeStats.population'
        db.alter_column('state_crime_stats', 'population', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'StateCrimeStats.population'
        db.alter_column('state_crime_stats', 'population', self.gf('django.db.models.fields.IntegerField')(default=''))
