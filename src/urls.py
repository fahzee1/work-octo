...
# Paid landing site
    ...
    urlpatterns += patterns('',
        ...
        dtt(r'^security-system/?$', 'affiliates/sem-landing-page/basic.html', 'security-system'),
        dtt(r'^security-systems/?$', 'affiliates/sem-landing-page/basic.html', 'security-systems'),
        ...
        dtt(r'^alarm-monitoring/?$', 'affiliates/sem-landing-page/alarm-monitoring.html', 'alarm-monitoring'),
...
# defaults
    ...
    urlpatterns += patterns('',
        ...
        url(r'^agent/resources/support/?$', 'apps.affiliates.views.agent_support_page', name='agent-support'),
